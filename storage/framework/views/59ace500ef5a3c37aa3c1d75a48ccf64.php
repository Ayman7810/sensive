...
<main class="site-main">
  ...
  <section class="section-margin--small section-margin">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <?php if(session('status-create-blog')): ?>
          <span style="color: red"><?php echo e(session('status-create-blog')); ?></span>
          <?php endif; ?>
          <form action="<?php echo e(route('blogs.store')); ?>" class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  <input class="form-control border" name="name"  type="text" placeholder="Enter titel blog" value="<?php echo e(old('name')); ?>">
...
<?php echo $__env->make('theme.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\sensive\resources\views/theme/blog/create.blade.php ENDPATH**/ ?>