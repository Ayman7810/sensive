   ...
   <section>
    <div class="container">
        ...
        <div class="card blog__slide text-center">
            ...
            <img class="card-img rounded-0" src="<?php echo e(asset('assets')); ?>/img/blog/blog-slider/blog-slide1.png" alt="">
            </div>
        ...
        <div class="card blog__slide text-center">
            <div class="blog__slide__img">
            <img class="card-img rounded-0" src="<?php echo e(asset('assets')); ?>/img/blog/blog-slider/blog-slide2.png" alt="">
            </div>
            <div class="blog__slide__content">
            <a class="blog__slide__label" href="#">Fashion</a>
            <h3><a href="#">New york fashion week's continued the evolution</a></h3>
        ...
        <div class="card blog__slide text-center">
            <div class="blog__slide__img">
            <img class="card-img rounded-0" src="<?php echo e(asset('assets')); ?>/img/blog/blog-slider/blog-slide3.png" alt="">
            </div>
            <div class="blog__slide__content">
            <a class="blog__slide__label" href="#">Fashion</a>
            <h3><a href="#">New york fashion week's continued the evolution</a></h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="thumb">
                        <img class="img-fluid" src="<?php echo e(asset('assets')); ?>/img/blog/blog1.png" alt="">
                        <ul class="thumb-info">
...
<?php echo $__env->make('theme.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\blog\resources\views/theme/index.blade.php ENDPATH**/ ?>